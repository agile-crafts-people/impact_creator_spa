describe('Navigation Drawer', () => {
  ...
  it('should have all post domain links in drawer', () => {
    ...
    cy.get('[data-automation-id="nav-posts-new-link"]').scrollIntoView().should('be.visible')
  })
  it('should have all comment domain links in drawer', () => {
    ...
    cy.get('[data-automation-id="nav-comments-new-link"]').scrollIntoView().should('be.visible')
  })
  it('should have classification domain link in drawer', () => {
    cy.visit('/dashboards')
    cy.get('[data-automation-id="nav-drawer-toggle"]').click()
    
    cy.get('[data-automation-id="nav-classifications-list-link"]').scrollIntoView().should('be.visible')
  })
